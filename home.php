...
<body class="bg-white">
        ...
        <ul class="list-group list-group-scrollable">
            <li class="list-group-item border"><b>Task 1</b></li>
            <li class="list-group-item border"><b>Task 2</b></li>
            <li class="list-group-item border"><b>Task 3</b></li>
            <li class="list-group-item border"><b>Task 4</b></li>
        </ul>

        <!-- Center Button -->
        <div class="fixed-bottom w-100 text-center mb-2">
            <button class="btn btn-primary" style="border-radius: 50%;" type="button" onclick="addTask()">
